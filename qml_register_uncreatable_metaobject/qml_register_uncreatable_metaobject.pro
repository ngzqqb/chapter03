# qml_register_uncreatable_metaobject/qml_register_uncreatable_metaobject.pro

TEMPLATE = app

CONFIG(debug,debug|release){
    TARGET = qml_register_uncreatable_metaobject_debug
}else{
    TARGET = qml_register_uncreatable_metaobject
}
...
QMLSOURCES += $$PWD/appqml/qml_register_uncreatable_metaobject/main.qml
